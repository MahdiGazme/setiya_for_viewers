...
import 'widgets/members_event_survey_list_view.dart';

class MembersEventSurveyList extends GetView<MembersEventSurveyListController> {
  const MembersEventSurveyList({final Key? key}) : super(key: key);
  ...
  Widget _bodyContent() => Column(
        children: [
          ...
          const Expanded(
            child: MembersEventSurveyListView(),
          ),
        ],
      );
