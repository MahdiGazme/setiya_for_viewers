...
import 'widget/members_events_list_view.dart';

class MembersEventsList extends GetView<MembersEventsListController> {
  const MembersEventsList({final Key? key}) : super(key: key);
