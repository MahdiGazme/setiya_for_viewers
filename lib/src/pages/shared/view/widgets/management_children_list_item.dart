...
import '../../models/management_child_view_model.dart';
import 'setia_avatar_selector/views/setia_avatar_selector.dart';

class ManagementChildrenListItem extends StatelessWidget {
  final ManagementChildViewModel child;
  final void Function()? onTap;

  const ManagementChildrenListItem({
    required this.child,
    required this.onTap,
    final Key? key,
  }) : super(key: key);
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                if (onTap != null) const Icon(Icons.keyboard_arrow_left)
              ],
            ),
          ),
        ),
