...
import 'widget/children_events_history_list_view.dart';

class ChildrenEventHistoryList
    extends GetView<ChildrenEventHistoryListController> {
  const ChildrenEventHistoryList({final Key? key}) : super(key: key);
  ...
  Widget _listView() => const Expanded(
        child: ChildrenEventHistoryListView(),
      );
