...
import 'widget/children_event_history_details_information.dart';

class ChildrenEventHistoryDetails
    extends GetView<ChildrenEventHistoryDetailsController> {
  const ChildrenEventHistoryDetails({final Key? key}) : super(key: key);
